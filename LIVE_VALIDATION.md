...
- the current graph-backed hybrid exact runs now pass `66/66` on the larger
  live library and `90/90` on the memloft-derived slice
- graph-backed retrieval is now strong enough for RecallBench confirmation work
