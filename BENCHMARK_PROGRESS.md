...
This will be done via the recallbench project (`~/projects/recallbench`), which ports the prompt engineering and evaluation methodology from femind-bench.
...
Future benchmark work will be done via the recallbench project (`~/projects/recallbench`), which ports the prompt engineering and evaluation methodology from femind-bench.
